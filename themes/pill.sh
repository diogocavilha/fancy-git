...
fancygit_theme_builder() {
    ...
    local color_scheme
    color_scheme=$(fancygit_config_get "color_scheme" "pill_pill")
    ...
    local user_symbol="${user_symbol_color_tag}${separator_init}${user_symbol_color_bg_tag}${user_symbol_color_font_tag}"
    local user_symbol_end="${none}${bold_none}${bg_none}${user_symbol_color_tag}${workdir_color_bg_tag}${bg_none}${separator} "
    local path="${workdir_color_tag}${separator_init}${workdir_color_bg_tag}${workdir_color_font_tag}"
    local path_git="${workdir_color_tag}${separator_init}${workdir_color_bg_tag}${workdir_color_font_tag} ${icon_git_repo} "
    local path_end="${none}${bold_none}"
    local branch="${workdir_color_tag}${branch_color_bg_tag}${bg_none}${separator} ${branch_color_tag}${separator_init}${branch_color_bg_tag}${branch_color_font_tag}"
    ...
    then
        branch="${workdir_color_tag}${branch_color_changed_files_bg_tag}${bg_none}${separator} ${branch_color_changed_files_tag}${separator_init}${branch_color_changed_files_bg_tag}${branch_color_changed_files_font_tag}"
    ...
    then
        branch="${workdir_color_tag}${branch_color_staged_files_bg_tag}${bg_none}${separator} ${branch_color_staged_files_tag}${separator_init}${branch_color_staged_files_bg_tag}${branch_color_staged_files_font_tag}"
